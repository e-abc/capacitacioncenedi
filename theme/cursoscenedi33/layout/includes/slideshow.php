...
$numberofslides = theme_cursoscenedi33_get_setting('numberofslides');
  ...
  <div id="home-page-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <?php for ($s1 = 1; $s1 <= $numberofslides; $s1++) :
                $clstxt2 = ($s1 == "1") ? ' active' : '';
                $slidecaption = theme_cursoscenedi33_get_setting('slide' . $s1 . 'caption', true);
                $slidedesc = theme_cursoscenedi33_get_setting('slide' . $s1 . 'desc', 'format_html');

                $slideimg = theme_cursoscenedi33_render_slideimg($s1, 'slide' . $s1 . 'image');
            ?>
