...
require_once($CFG->dirroot.'/theme/cursoscenedi33/edit_form.php');
...
$PAGE->set_url('//theme/cursoscenedi33/editprofile.php', array('course' => $course, 'id' => $userid));
...
if ($course->id != SITEID) {
    ...
    if (empty($SESSION->wantsurl)) {
        $SESSION->wantsurl = $CFG->httpswwwroot.'//theme/cursoscenedi33/editprofile.php';
    }
...
// Create form.
$userform = new user_edit_form_cenedi(new moodle_url($PAGE->url, array('returnto' => $returnto)), array(
