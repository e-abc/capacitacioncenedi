...
/**
 * Strings for component 'theme_cursoscenedi33', language 'en'
 *
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="cursoscenedi33/pix/screenshot.jpg" /><h3>قروض موضوع</h3><p><h3>Moodle cursoscenedi33 موضوع</h3><p>ويستند هذا الموضوع على موضوع Bootstrapbase موودل.</p><p><a href="http://getbootstrap.com">http://getbootstrap.com</a></p>
<p>
المؤلف: LMSACE فريق ديف<br>
الاتصال: info@lmsace.com<br>
موقع الكتروني: <a href="http://www.lmsace.com">www.lmsace.com</a><br></p>';
$string['configtitle'] = 'cursoscenedi33';
$string['connectus'] = 'اتصل بنا';
$string['contact'] = 'اتصال';
$string['copyright_footer'] = 'حق النشر';
$string['copyright_default'] = 'حقوق الطبع والنشر والنسخ. 2017 - وضعت من قبل <a href="http://lmsace.com">LMSACE.com</a>. مشغل بواسطة <a href="https://moodle.org">Moodle</a>';
...
$string['footnotedefault'] = '<p>أبجد هوز هو مجرد دمية النص من صناعة المطابع ودور النشر. وكان أبجد هوز في هذه الصناعة القياسية دمية النص من أي وقت مضى منذ 1500s، عندما مجهول مقعدا الطابعة الطباعة من نوع والتنضيد ترونيك، وصحائف taining الممرات أبجد هوز.<br><a href="#">اقرأ أكثر &raquo;</a></p>';
...
$string['infoblocktextdefault'] = '<p>أبجد هوز هو مجرد دمية النص من صناعة المطابع ودور النشر. وكان أبجد هوز النص القياسي في هذه الصناعة وهمية من أي وقت مضى منذ 1500s، عندما مجهول مقعدا الطابعة الطباعة من نوع وسارعت الى تقديم نوع العينة الكتاب. وقد نجا خمسة قرون فحسب <a href="javascript:void(0);">اقرأ أكثر <i class="fa fa-angle-double-right"></i></a></p>';
...
$string['infolink_desc'] = 'يمكنك تكوين معلومات العرف سريعة هنا ليتم عرضها حسب المواضيع. يتكون كل سطر من بعض النصوص القائمة، وURL رابط (اختياري)، وهو اللقب تلميح الأدوات (اختياري) ورمز اللغة أو مفصولة بفواصل قائمة رموز (اختياري، لعرض خط لمستخدمي اللغة المحددة فقط)، مفصولة الأنابيب characters.For سبيل المثال:<pre>المجتمع موودل|https://moodle.org
الدعم المجاني موودل|https://moodle.org/support
تطوير موودل|https://moodle.org/development
موودل|http://docs.moodle.org|Moodle Docs
...
$string['logo'] = 'شعار';
$string['logodesc'] = 'يرجى تحميل شعار مخصص هنا إذا كنت ترغب في إضافته إلى الرأس<br>يجب أن تكون الصورة 37px عالية وأي عرض معقول (الحد الأدنى: 250px) أن الدعاوى.';
...
$string['newseventcontent'] = '<div class="row"><div class="col-lg-6 col-md-6 col-sm-6"><div class="embed-wrap"><div class="embed-responsive embed-responsive-16by9"><iframe src="https://www.youtube.com/embed/fNE7pyDyw3Y" allowfullscreen="" frameborder="0" height="391" width="545"></iframe></div></div></div><div class="col-lg-6 col-md-6 col-sm-6"><div class="info-wrap"><h2 class="nomargint">news &amp; events of 2017</h2><p>أبجد هوز هو مجرد دمية النص من صناعة المطابع ودور النشر. وكان أبجد هوز النص القياسي في هذه الصناعة وهمية من أي وقت مضى منذ 1500s، عندما مجهول مقعدا الطابعة الطباعة من نوع وسارعت الى تقديم نوع العينة الكتاب. وقد نجا خمسة قرون فحسب، بل أيضا قفزة في التنضيد الالكتروني، وصحائف taining أبجد هوز الممرات، ومؤخرا في التنضيد الالكتروني، وصحائف taining أبجد هوز الممرات، وأكثر من ذلك recentwith برامج النشر المكتبي مثل PageMaker ألدوس بما في ذلك إصدارات أبجد هوز.</p><div class="readmore-btn"><a href="#">اقرأ أكثر</a></div></div></div></div>';
...
$string['sb2_default_title'] = 'تصبح مدرس';
$string['sb3_default_cnt'] = '<p>أبجد هوز هو مجرد دمية النص من <br class="visible-lg">صناعة الطباعة والتنضيد.</p>';
$string['sb3_default_title'] = 'تسجيل المقررات';
$string['sb4_default_cnt'] = '<p>أبجد هوز هو مجرد دمية النص من <br class="visible-lg">صناعة الطباعة والتنضيد.</p>';
...
$string['slidedescdefault'] = '<p>Neque بورو quisquam بتوقيت شرق الولايات المتحدة خامسة dolorem هوز quia دولور الجلوس امات، consectetur، adipisci velit</p>';
