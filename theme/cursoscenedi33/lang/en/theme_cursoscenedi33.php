...
$string['configtitle'] = "cursoscenedi33 Settings";
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot">
<img class=img-polaroid src="cursoscenedi33/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle cursoscenedi33 theme</h3>
<p>
...
$string['pluginname'] = 'cursoscenedi33';
...
//cursos destacados
$string['cursosdestacados'] = "Featured Courses";
$string['headingfeaturedcourses'] = "Featured Courses";
$string['selection'] = "Select highlighted courses";
$string['selectiondesc'] = "Enter the short name of the courses separated by an 'enter'";
$string['selectcourse'] = 'Courses to show';
$string['enable'] = 'Enable';
$string['enabledesc'] = 'Enable featured courses';

$string['enable'] = 'Enable';
$string['enabledesc'] = 'Enable featured courses';

$string['selectionenable'] = 'Selection of courses to show Enable';
$string['selectionenabledesc'] = 'If this option is enabled courses in "Select highlighted courses" will be displayed as Featured Courses';

$string['morevisitedenable'] = 'More visited courses to show Enable';
$string['morevisitedenabledesc'] = 'If this option is enabled courses more visited courses will be displayed as Featured Courses.';

$string['typefcourses'] = 'Select type of view';
$string['typefcoursesdesc'] = 'Select your options to show Featured courses.';
$string['myselection'] = 'My selection';
$string['morevisited'] = 'Most visited courses';
$string['moreuserenrol'] = 'Courses with more enroled users';
$string['tagedcourses'] = 'Courses with this tag';

$string['tagedcoursesdesc'] = 'Enter the tag used in the courses you want to show';

$string['howmanyfcourses'] = 'Select how many courses to show';
$string['howmanyfcoursesdesc'] = 'Select how many courses to show. Only for "Most visited courses", "Courses with more enroled users"';
