...
class theme_cursoscenedi33_core_course_renderer extends core_course_renderer {
    ...
    protected function coursecat_courses(coursecat_helper $chelper, $courses, $totalcount = null) {
        ...
        */
        ...
        // e-ABC 20171211 incidente con el usuario: ar34817106
        // fuerzo $fcoursesenabled HABILITADO
        // fuerzo tipo 4 : cursos con el tag.
        // fuerzo que el tag sea "cursoprincipal"
        // articularidad de CENEDI
        $fcoursesenabled = true;
        $typefcourses = 4;
        $tag = 'cursoprincipal';
        ...
        /*
        global $USER;
        if($USER->username == 'ar34817106'){
            echo "<pre>";
            $content .= var_export($searchcourses, true);
            echo "</pre>";
        }
        */
