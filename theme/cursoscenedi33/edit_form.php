 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_edit_form_cenedi extends moodleform {
    ...
    public function definition () {
        ...
        //
        $mform->removeElement('userpicturewarning');
        $mform->removeElement('deletepicture');
        $mform->removeElement('moodle_additional_names');
        $mform->removeElement('moodle_interests');
        $mform->removeElement('moodle_optional');
        $mform->removeElement('imagealt');
        $mform->removeElement('firstnamephonetic');
        $mform->removeElement('lastnamephonetic');
        $mform->removeElement('middlename');
        $mform->removeElement('alternatename');
        $mform->removeElement('interests');
        $mform->removeElement('url');
        $mform->removeElement('icq');
        $mform->removeElement('skype');
        $mform->removeElement('aim');
        $mform->removeElement('idnumber');
        $mform->removeElement('department');
        $mform->removeElement('phone1');
        $mform->removeElement('phone2');
        $mform->removeElement('address');

        $mform->removeElement('maildisplay');
        $mform->removeElement('city');
        $mform->removeElement('timezone');
        $mform->removeElement('description_editor');
        $mform->removeElement('yahoo');
        $mform->removeElement('msn');
        $mform->removeElement('institution');
